...
hweq_t hweq_param[] = {
	...
	{/* SPK */
		...
		{0xf9a3,0x0000,	0xc883,	0x1c10,	0x0000,	0xd588,	0x1c10,	0x0000,	0xe904,	0x1c10,	0x0000, 0xe904,	0x1c10,	0x0000,	0x1ec4,	0x0000,	0x1f5c,	0x0000,	0x1f5f},
		0x01e1,
	},
	{/* HP */
		{0xa0,	0xa1,	0xa2,	0xa3,	0xa4,	0xa5,	0xa6,	0xa7,	0xa8,	0xa9,	0xaa,	0xab,	0xac,	0xad,	0xae,	0xaf,	0xb0,	0xb1,	0xb2},
		{0x1c10,0x01f4,	0xc5e9,	0x1a98,	0x1d2c,	0xc882,	0x1c10,	0x01f4,	0xe904,	0x1c10,	0x01f4, 0xe904,	0x1c10,	0x01f4,	0x0436,	0x01f4,	0x1d0b,	0x0000,	0x2000},
		0x0000,
	},
	{/* Vocal */
	...
	struct snd_soc_codec *codec, int mode, int set_custom_eqmode)
{
	...
	dev_dbg(codec->dev,
	    "%s(): mode=%d set_custom_eqmode=%d\n",
	    __func__, mode, set_custom_eqmode);

	if (set_custom_eqmode) {
		custom_eqmode = mode;
		if (!(snd_soc_read(codec, RT5640_PWR_DIG1) &
