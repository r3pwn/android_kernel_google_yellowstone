/*
 * arch/arm/mach-tegra/board-yellowstone-powermon.c
 *
...
#define PRECISION_MULTIPLIER_YELLOWSTONE	1000
...
/* rails on YELLOWSTONE_P1761 i2c */
enum {
	VDD_BAT_CPU_GPU,
};
/* rails on YELLOWSTONE_P1761-A02 i2c */
enum {
	VDD_BAT_USB_MDM,
};
enum {
...
static struct ina3221_platform_data yellowstone_p1761_power_mon_info[] = {
	[VDD_BAT_CPU_GPU] = {
...
static struct i2c_board_info yellowstone_p1761_i2c_ina3221_info[] = {
	[INA_I2C_ADDR_40] = {
		I2C_BOARD_INFO("ina3221", 0x40),
		.platform_data = &yellowstone_p1761_power_mon_info[VDD_BAT_CPU_GPU],
		.irq = -1,
	},
};

static struct ina3221_platform_data yellowstone_p1761_a02_power_mon_info[] = {
	[VDD_BAT_USB_MDM] = {
...
static struct i2c_board_info yellowstone_p1761_a02_i2c_ina3221_info[] = {
	[INA_I2C_ADDR_40] = {
		I2C_BOARD_INFO("ina3221", 0x40),
		.platform_data = &yellowstone_p1761_a02_power_mon_info[VDD_BAT_USB_MDM],
		.irq = -1,
	},
};
...
static struct ina230_platform_data e1784_A00_power_mon_info_1[] = {
	[E1784_A00_VDD_BAT_CHG] = {
		...
		.power_lsb = 6.86695279 * PRECISION_MULTIPLIER_YELLOWSTONE ,
		.rail_name = "VDD_BAT_CHG",
		.trig_conf = INA230_TRIG_CONFIG,
		.cont_conf = INA230_CONT_CONFIG,
		.divisor = 25,
		.precision_multiplier = PRECISION_MULTIPLIER_YELLOWSTONE ,
		.resistor = 5,
	},

	[E1784_A00_VDD_SYS_BUCKCPU] = {
		.calibration_data  = 0x0F9D,
		.power_lsb = 3.202401801 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_SYS_BUCKGPU] = {
		...
		.power_lsb = 2.135112594 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_SYS_BUCKSOC] = {
		...
		.power_lsb = 1.067467267 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_5V0_SD2] = {
		...
		.power_lsb = 0.660747471 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_WWAN_MDM] = {
		...
		.power_lsb = 1.581711461 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_SYS_BL] = {
		...
		.power_lsb = 0.36699352 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_3V3A_COM] = {
		...
		.power_lsb = 0.413570275 * PRECISION_MULTIPLIER_YELLOWSTONE ,
...
static struct ina230_platform_data e1784_A00_power_mon_info_2[] = {
	[E1784_A00_VDD_RTC_LDO3] = {
		...
		.power_lsb = 0.078127384 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_3V3A_LDO1_6] = {
		.calibration_data  = 0x7FFF,
		.power_lsb = 0.003906369 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_DIS_3V3_LCD] = {
		.calibration_data  = 0x7FFF,
		.power_lsb = 0.390636921 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_LCD_1V8B_DIS] = {
		.calibration_data  = 0x7FFF,
		.power_lsb = 0.039063692 * PRECISION_MULTIPLIER_YELLOWSTONE ,
...
static struct ina230_platform_data e1784_A00_power_mon_info_3[] = {
	[E1784_A00_VDD_GPU_BUCKGPU] = {
		...
		.power_lsb = 6.103958035 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_SOC_SD1] = {
		.calibration_data  = 0x7FFF,
		.power_lsb = 3.906369213 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_CPU_BUCKCPU] = {
		...
		.power_lsb = 9.155937053 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_1V8_SD5] = {
		.calibration_data  = 0x7FFF,
		.power_lsb = 1.302123071 * PRECISION_MULTIPLIER_YELLOWSTONE ,
	...
	[E1784_A00_VDD_1V05_LDO0] = {
		.calibration_data  = 0x7FFF,
		.power_lsb = 0.130212307 * PRECISION_MULTIPLIER_YELLOWSTONE ,
...
static void __init register_devices_e1784_a00(void)
{
	i2c_register_board_info(PCA954x_I2C_BUS0,
			yellowstone_p1761_i2c_ina3221_info,
			ARRAY_SIZE(yellowstone_p1761_i2c_ina3221_info));
...
int __init yellowstone_p1761_pmon_init(void)
{
	...
	if (bi.board_id == BOARD_E1784)
		...
		ret = i2c_register_board_info(1, yellowstone_p1761_a02_i2c_ina3221_info,
					      ARRAY_SIZE(yellowstone_p1761_a02_i2c_ina3221_info));
	else
		ret = i2c_register_board_info(1, yellowstone_p1761_i2c_ina3221_info,
					      ARRAY_SIZE(yellowstone_p1761_i2c_ina3221_info));
