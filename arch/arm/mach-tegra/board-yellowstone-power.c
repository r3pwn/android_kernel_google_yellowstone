...
/* -40 to 125 degC */
static int yellowstone_batt_temperature_table[] = {
...
static struct gadc_thermal_platform_data gadc_thermal_battery_pdata = {
	...
	.temp_offset = 0,
	.adc_to_temp = NULL,
	.adc_temp_lookup = yellowstone_batt_temperature_table,
	.lookup_table_size = ARRAY_SIZE(yellowstone_batt_temperature_table),
...
int __init yellowstone_fixed_regulator_init(void)
{
	return 0;
}
